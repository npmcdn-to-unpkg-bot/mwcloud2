...
@Component({
    moduleId: module.id,
    selector: 'mw-timer-picker',
    templateUrl:'mw-timer-picker.component.html',
    styleUrls: ['mw-timer-picker.component.css']
})

export class MwTimerPicker implements OnInit, OnChanges {
    @Input() options:any;
    @Input() locale:string;
